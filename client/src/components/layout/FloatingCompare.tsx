...
const FloatingCompare: React.FC = () => {
  ...
  return (
    <div className="hidden md:flex fixed top-24 left-6 z-[45] flex-col items-center gap-1 transition-all duration-500">
      <button
      ...
      >
        ...
        <span className="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center text-xs font-bold shadow-md">
          {compareCount}
        </span>
      </button>
      <span className="text-xs font-semibold text-purple-700 bg-white/90 px-2 py-1 rounded-full shadow-sm">
