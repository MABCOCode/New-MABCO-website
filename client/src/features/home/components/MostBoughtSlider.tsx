                ...
                <div className="h-full">
                  <div className="bg-white rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:border-[#009FE3]/30 overflow-hidden flex flex-col h-full">
                        ...
                        (() => {
                          ...
                          return (
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                console.log('[MostBoughtSlider] compare button click', { id: product.id });
                    ...
                    <div className="p-3 flex flex-col flex-1 justify-between">
                      {/* Product Name with fixed height to prevent wrapping differences */}
                      <h3
                      ...
                      <div
                        className={`flex items-center ${
                          product.oldPrice ? "justify-between" : "justify-start"
                        } mb-3 min-h-[3.5rem]`}
                      >
                        <div
                          className={
